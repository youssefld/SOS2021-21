<main>
	<h1>
		<strong>SOS2021-21 Información</strong>
	</h1>
	<h2>Equipo:</h2>
	<ul>
		<li>
		...
		<li><a href="https://github.com/pauleasal">Paula Leal Salvago</a></li>
		<li>
	...
	<p>
		<strong>URL:</strong>
		<a href="http://sos2021-21.herokuapp.com"
			>http://sos2021-21.herokuapp.com</a
		>
	</p>
	<p>
		<strong>APIs:</strong>
